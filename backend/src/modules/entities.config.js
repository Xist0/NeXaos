  ...
  const entities = [
    ...
    },
    {
      ...
      columns: {
        ...
        hardware_matrix: { type: "json", allowNull: true },
        is_active: { type: "boolean" },
      },
    ...
    },
    {
      ...
      columns: {
        name: { type: "string", required: true, max: 255 },
        sku: { type: "string", max: 255, allowNull: true },
        unit_id: { type: "integer", allowNull: true },
        material_class_id: { type: "integer", allowNull: true },
        price_per_unit: { type: "number", precision: 2, allowNull: true },
        edge_price_per_m: { type: "number", precision: 2, allowNull: true },
        purpose: { type: "string", allowNull: true },
        comment: { type: "string", allowNull: true },
        length_mm: { type: "integer", allowNull: true },
        width_mm: { type: "integer", allowNull: true },
        price_per_piece: { type: "number", precision: 2, allowNull: true },
        is_active: { type: "boolean" },
      },
    },
    {
      ...
      columns: {
        ...
        price_per_m2: { type: "number", precision: 2, allowNull: true },
        edge_price_per_m: { type: "number", precision: 2, allowNull: true },
        purpose: { type: "string", allowNull: true },
        hardware_color: { type: "string", allowNull: true },
        texture_url: { type: "string", allowNull: true },
        comment: { type: "string", allowNull: true },
        sheet_length_mm: { type: "integer", allowNull: true },
        sheet_width_mm: { type: "integer", allowNull: true },
        countertop_size: { type: "string", allowNull: true },
        price_per_sheet: { type: "number", precision: 2, allowNull: true },
        coefficient: { type: "number", precision: 4, allowNull: true },
        is_active: { type: "boolean" },
      },
    },
    {
      ...
      idColumn: "id",
      columns: {
        base_sku: { type: "string", max: 50, allowNull: true },
        name: { type: "string", required: true, max: 255 },
        sku: { type: "string", max: 255, allowNull: true },
        unit_id: { type: "integer", allowNull: true },
        material_class_id: { type: "integer", allowNull: true },
    ...
    },
    {
      ...
      columns: {
        ...
        hex: { type: "string", max: 7, allowNull: true },
    ...
    },
    {
      ...
      columns: {
        name: { type: "string", required: true, max: 255 },
        category_id: { type: "integer", allowNull: true },
        field_key: { type: "string", max: 128, allowNull: true },
        sort_order: { type: "integer", allowNull: true },
      },
    },
    {
