...
export const PRODUCT_CHARACTERISTIC_FIELDS = {
  ...
  edge_band: { label: "Кромка на корпус", selectType: "sheet", priceKey: "edge_price_per_m", categoryFilter: "Кромка" },
  edge_band_facade: { label: "Кромка на фасад", selectType: "sheet", priceKey: "edge_price_per_m", categoryFilter: "Кромка" },
...
export const PRODUCT_CHARACTERISTIC_SECTIONS = [
  {
    ...
    lines: [
      ...
      ["edge_band", "edge_band_facade", "glass_in_frame"],
    ],
  },
  {
    id: "main",
    ...
    lines: [
      ...
      ["hinges_count", "hinges_type", "hinges_detail"],
  ...
  },
  {
    ...
    lines: [
      ...
      ["cutlery_tray", "dish_dryer", "ventilation_grid"],
      ["side_posts_facade_color", null, null],
    ],
  },
];
