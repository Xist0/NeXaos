...
const SecureButton = ({
  ...
  return (
    <button
      ...
      data-safe-click
      className={clsx(
        "relative inline-flex items-center justify-center rounded-full px-6 py-3 font-semibold leading-none tracking-wide transition-transform duration-200 shadow-md [&_svg]:block [&_svg]:shrink-0",
        variant === "ghost"
